...
%% plot diff instead of ratio without rum

diff_sleep=length_nrem_rem_dark-length_nrem_rem_light;
...
ylim([-21 21])
yticks([-20:10:20])
ylabel('{\Delta} sleep (min/h)','FontSize',18)
xlim([0 25])
% xticks([2 8 14 20])
% xticklabels({'12','18','00','6'})
% xlabel('time windows (clock time)','FontSize',18)
...
for i=1:24
    ...
    [h,p_dec(i)] = ttest(length_nrem_rem_dark(i,[1 4 9]),length_nrem_rem_light(i,[1 4 9]));
    [h,p_july(i)] = ttest(length_nrem_rem_dark(i,[2 5 7 10]),length_nrem_rem_light(i,[2 5 7 10]));
    [h,p_sep(i)] = ttest(length_nrem_rem_dark(i,[3 6 8 11]),length_nrem_rem_light(i,[3 6 8 11]));
